...
class AddNewContact(unittest.TestCase):
    ...
    def test_add_new_contact(self):
        ...
        self.create_contact(wd, firstname="Erast", lastname="Fandorin", nickname="Juffin Hally", company="Adventures", mobile="+79991112233",
    ...
    def create_contact(self, wd, firstname, lastname, nickname, company, mobile, email, bday, bmonth, byears):
        # init new contact
        ...
        wd.find_element_by_name("byear").send_keys("%s" % byears)
        # submit new contact
